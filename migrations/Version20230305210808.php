 ...
 */
final class Version20230305210808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (nsc VARCHAR(20) NOT NULL, class_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, enabled TINYINT(1) NOT NULL, moyenne DOUBLE PRECISION NOT NULL, INDEX IDX_B723AF33EA000B10 (class_id), PRIMARY KEY(nsc)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
